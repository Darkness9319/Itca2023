<?php 
    ...
    $pdf->SetXY(145,30);
    $pdf->Cell(20,5,utf8_decode('Código de Afiliación: '),0,0);

    $pdf->SetFont('Courier', '', 14);
    $pdf->SetTextColor(255, 0, 0);
    $pdf->SetXY(180,30);    
    $pdf->Cell(20,5,$codigoSoc,0,0);
